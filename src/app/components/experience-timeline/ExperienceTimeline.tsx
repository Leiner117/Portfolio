...
export const ExperienceTimeline: React.FC = () => {
  ...
  return (
    <div ref={timelineRef} className="relative max-w-5xl mx-auto">
      ...
      <div
        className="hidden md:block absolute left-4 md:left-1/2 top-0 w-px transition-all duration-300 ease-out"
        ...
        {experiences.map((exp, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute left-4 md:left-1/2 -ml-2 md:-ml-4 z-10 hidden md:block">
                <div
                  className={
              ...
              <div
                className={
                  "w-full md:w-[calc(50%-4rem)] ml-4 md:ml-0 " +
              ...
              >
                <div className="relative group perspective-1000">
                  <div className="relative experience-card backdrop-blur-md border rounded-xl p-4 md:p-6 transition-all duration-200 shadow-xl group-hover:scale-[1.02] group-hover:shadow-2xl">
                    <div
                      className="inline-flex items-center gap-2 px-4 py-1.5 border rounded-full text-sm mb-4 font-medium"
                      style={{
                        color: "inherit",
